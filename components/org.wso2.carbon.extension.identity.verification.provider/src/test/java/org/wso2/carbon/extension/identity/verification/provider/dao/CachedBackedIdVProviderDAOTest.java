...
public class CachedBackedIdVProviderDAOTest {
    ...
    public void testGetIdVProvider() throws Exception {
        ...
        when(idVProviderCacheEntry.getIdVProvider()).thenReturn(identityVerificationProvider);
    ...
    public void testAddIdVProvider() throws Exception {
        ...
        doNothing().when(idVProviderDAOImpl).
                addIdVProvider(any(IdVProvider.class), anyInt());
    ...
    public void testUpdateIdVProvider() throws Exception {
        ...
        IdVProvider identityVerificationProvider = addTestIdVProvider();
        doNothing().when(idVProviderDAOImpl).updateIdVProvider(any(IdVProvider.class),
                any(IdVProvider.class), anyInt());
    ...
    public void testGetIdVPByName() throws Exception {
        ...
        when(idVProviderCacheEntry.getIdVProvider()).thenReturn(identityVerificationProvider);
        IdVProvider idVProvider =
                idVProviderDAO.getIdVProviderByName(idVProviderName, tenantId);
        Assert.assertEquals(idVProvider.getIdVProviderName(), idVProviderName);
    }
