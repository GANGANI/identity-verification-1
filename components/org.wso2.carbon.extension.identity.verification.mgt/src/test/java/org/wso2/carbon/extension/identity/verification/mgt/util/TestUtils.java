...
public class TestUtils {
    ...
    public static Map<String, BasicDataSource> initiateH2Base() throws Exception {

        Map<String, BasicDataSource> dataSourceMap = new HashMap<>();
    ...
    public static Connection getConnection() throws Exception {
        ...
        dataSourceMap = initiateH2Base();
        if (dataSourceMap.get(DB_NAME) != null) {
            connection = dataSourceMap.get(DB_NAME).getConnection();
            return connection;
        }
