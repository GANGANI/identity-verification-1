...
//
    ...
    public void testGetIdVClaim() throws Exception {
        ...
        identityVerification = new IdentityVerificationManagement();
        ...
        Assert.assertEquals(idVClaim.getUuid(), "575a3d28-c6fb-46c8-bf63-45530448ca17");
    }
    ...
    public void testAddIdVClaims() throws Exception {
        ...
        List<IdVClaim> addedIdVClaims =
                identityVerification.addIdVClaims("715558cb-d9c1-4a23-af09-3d95284d8e2b",
                        idVClaims, -1234);
        Assert.assertEquals(addedIdVClaims.get(0).getUuid(), "575a3d28-c6fb-46c8-bf63-45530448ca17");
    }
