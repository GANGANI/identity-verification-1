...
public class IdentityVerificationConstants {
    ...
    public enum ErrorMessage {
        ...
        ERROR_INVALID_CLAIM_URI("65002", "Claim URI not found."),
        ERROR_CHECKING_IDV_CLAIM_EXISTENCE("65003",
                "Error while checking the existence of the Identity Verification Claim."),
        ERROR_INVALID_USER_ID("60004", "User cannot be found with the user Id: %s."),
        ERROR_RESOLVING_USER("60004", "Error occured while resolving the user"),

        ERROR_INVALID_IDV_CLAIM_ID("65004", "Identity verification claim cannot be found with the " +
                "claim id: %s."),
